...
{
    public class MoveMap : MonoBehaviour, IInputClickHandler
    {
        ...
        [Tooltip("Collider to use when using collider center")]
        public Collider ColliderToCollide;
        /// <summary>
        ...
        protected virtual void Update()
        {
            ...
            {
                placementPosition += ColliderToCollide.bounds.center- ColliderToCollide.transform.position;
            }
